...
write.csv(Event, file = "Event.csv")
write.csv(Rounds, file = "Rounds.csv")
write.csv(Placements, file = "Placements.csv")
write.csv(Athletes, file = "Athletes.csv")
write.csv(Couples, file = "Couples.csv")
