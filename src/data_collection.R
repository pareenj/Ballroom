library(rvest); library(plyr); library(dplyr); library(stringr); library(httr); library(RCurl); library(zoo); library(pystr); library(foreach); library(doParallel); library(RODBC)
